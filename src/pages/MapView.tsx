...
const MapView = () => {
  ...
  const [userLoc] = useState<[number, number]>([14.6928, -17.4467]); // Dakar
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.5rem)]">
      ...
      <div className="px-4 py-3 border-b bg-card flex items-center gap-3">
        ...
        <Badge variant="outline" className="text-xs">{filtered.length} {t.equipment.available.toLowerCase()}</Badge>
      </div>
